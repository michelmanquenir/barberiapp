...
import {
  ...
  Package, Search, Loader2, Camera, CameraOff, AlertCircle,
  ReceiptText,
} from 'lucide-react'
      ...
      <div className="flex-1 relative flex items-center justify-center bg-black">
        {error ? (
          <div className="text-center px-6">
            ...
            <button onClick={onClose} className="mt-4 px-6 py-2 bg-white text-gray-900 rounded-xl text-sm font-medium">
              Volver
            </button>
          </div>
        ) : (
